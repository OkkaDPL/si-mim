...
@section('isibody')
    <div class="content">
        <div class="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <form action="/dashboard/purchaseorders/{{ $purchaseorder->id }}/submit" method="POST"
                            ...
                            <div class="table">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" name="tglCreate" id="tglCreate"
                                                    ...
                                                    value="{{ old('tglCreate', $purchaseorder->tglCreate) }}">
                                                @error('tglCreate')
                                            ...
                                            <td>
                                                <input type="date" name="tglExp" id="tglExp"
                                                    ...
                                                    value="{{ old('tglExp', $purchaseorder->tglExp) }}">
                                                @error('tglExp')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <tr>
                                            <td colspan="3"><a class="b"
                                                    href="{{ asset('storage/' . $purchaseorder->pricelist) }}">Price
                                                    list</a> *file type
                                                must PDF</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <select
                                                            ...
                                                            @foreach ($parts as $part)
                                                                @if (old('part_id.', $item->part_id) == $part->id)
                                                        ...
                                                        <input type="text" name="part_id[]" class="hapusValue"
                                                            id="part_id"value="{{ old('part_id.', $item->part_id) }}"
                                                            required hidden>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="nama[]" id="nama"
                                                            class="partNama form-control input-border-bottom @error('nama.' . $key) is-invalid @enderror"
                                                            list="list-nama" value="{{ old('nama.', $item->part->nama) }}"
                                                            required>
                                                        @error('nama.' . $key)
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                        ...
                                                        <datalist id="list-nama">
                                                            ...
                                                            @foreach ($parts as $part)
                                                                @if (old('nama.', $item->part_id) == $part->nama)
                                                    ...
                                                    <td>
                                                        <input name="uom[]" id=uom type="text"
                                                            ...
                                                            readonly value="{{ old('uom.', $item->part->uom->nama) }}">
                                                        @error('uom.' . $key)
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <td>
                                                        <input id="hargasat" name="hargasat[]" type="text"
                                                            ...
                                                            required
                                                            value="{{ old('hargasat.', number_format($item->hargasat, 0, '.', ',')) }}"
                                                    ...
                                                    <td>
                                                        <input id="qty" name="qty[]" type="text"
                                                            ...
                                                            pattern="[0-9]{1,5}" onkeyup="calculateTotal(this)">
                                                        @error('qty.' . $key)
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <td>
                                                        <input name="hargatot[]" id="hargatot" type="text"
                                                            ...
                                                            required readonly
                                                            value="{{ old('hargatot.', number_format($item->hargatot, 0, '.', ',')) }}"
                                                            onkeyup="formatNumber(this); calculateTotal(this)">
                                                        @error('hargatot.' . $key)
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger removeRow"><span><i
                                                                    class="flaticon-interface-5"></i></span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="form-group form-floating-label col-md-6 float-right">
                                    ...
                                    <textarea class="form-control @error('note') is-invalid @enderror" required id="note" name="note"
                                        type="text" rows="5">{{ old('note', $purchaseorder->note) }}</textarea>
                                    @error('note')
                            ...
                            <div class="form-group form-floating-label">
                                <div class="col-md-3 float-right">
                                    ...
                                    <input id="amount" name="amount" type="text"
                                        ...
                                        required
                                        value="{{ old('amount', number_format($purchaseorder->amount, 2, '.', ',')) }}"
                            ...
                            <div class="form-group form-floating-label">
                                <div class="col-md-3 float-right">
                                    ...
                                    <input id="ppn" name="ppn" type="text"
                                        ...
                                        required value="{{ old('ppn', number_format($purchaseorder->ppn, 2, '.', ',')) }}"
                                        onkeyup="formatNumber(this); calculateTotal()" readonly>
                                    @error('ppn')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="form-group form-floating-label">
                                <div class="col-md-3 float-right">
                                    ...
                                    <input id="gtotal" name="gtotal" type="text"
                                        ...
                                        value="{{ old('gtotal', number_format($purchaseorder->gtotal, 2, '.', ',')) }}"
                                        onkeyup="formatNumber(this); calculateTotal()" readonly>
                                    @error('gtotal')
                                        <div class="invalid-feedback">
                                            {{ $message }}
