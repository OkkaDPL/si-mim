                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="/exportExcel/inventorytransfer" class="btn btn-success btn-round">
                                        <i class="fa fa-file"></i>
                                        Excel
                                    </a>
                                    <a href="/dashboard/inventorytransfer/create" class="btn btn-primary btn-round">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/dashboard/inventorytransfer/{{ $inventorytransfer->id }}"
