                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="/exportExcel/deliveryorders" class="btn btn-round btn-success">
                                        <i class="fa fa-file"></i>
                                        Excel
                                    </a>
                                    <a href="/dashboard/deliveryorders/create" class="btn btn-primary btn-round">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/dashboard/deliveryorders/{{ $do->id }}"
