                            ...
                            <div class="card-body">
                                <div class="form-group form-floating-label">
                                    <input id="kd_parts" name="kd_parts" type="text"
                                        ...
                                        required value="{{ old('kd_parts', $part->kd_parts) }}">
                                ...
                                <div class="form-group form-floating-label">
                                    <input id="nama" name="nama" type="text"
                                        ...
                                        required value="{{ old('nama', $part->nama) }}">
                                ...
                                <div class="form-group form-floating-label">
                                    ...
                                    <select class="iniSelect form-control @error('uom_id') is-invalid @enderror"
                                        ...
                                        @foreach ($uoms as $uom)
                                            @if (old('uom_id', $part->uom_id) == $uom->id)
                                                <option value="{{ $uom->id }}" selected>{{ $uom->nama }}
                                                </option>
                                            @else
                                ...
                                <div class="form-group form-floating-label">
                                    ...
                                    <select class="iniSelect form-control @error('category_id') is-invalid @enderror"
                                        ...
                                        @foreach ($categories as $category)
                                            @if (old('category_id', $part->category_id) == $category->id)
