                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/dashboard/principals/create" class="btn btn-primary btn-round ml-auto">
                                    ...
                                    <tbody>
                                        @foreach ($principals as $principal)
                                            <tr>
                                                ...
                                                <td>{{ $principal->id_principals }}</td>
                                                <td>{{ $principal->nama }}</td>
                                                <td>{{ $principal->tlp }}</td>
                                                <td>{{ $principal->email }}</td>
                                                <td>{{ $principal->alamat }}</td>
                                                <td>{{ $principal->drek }}</td>
                                                <td>{{ $principal->norek }}</td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/dashboard/principals/{{ $principal->id }}/edit"
                                                            data-toggle="tooltip" class="btn btn-link btn-primary btn-lg"
                                                            data-original-title="Edit Data"><span
                                                                class="fa fa-edit"></span></a>
                                                        <form action="/dashboard/principals/{{ $principal->id }}"
