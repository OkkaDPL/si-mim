                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/dashboard/customers/create" class="btn btn-primary btn-round ml-auto">
                                    ...
                                    <tbody>
                                        @foreach ($customers as $customer)
                                            <tr>
                                                ...
                                                <td>{{ $customer->snpwp }}</td>
                                                <td>{{ $customer->nonpwp }}</td>
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <form action="/dashboard/customers/{{ $customer->id }}"
