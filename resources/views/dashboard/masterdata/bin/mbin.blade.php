                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/dashboard/bins/create" class="btn btn-primary btn-round ml-auto">
                                    ...
                                    <tbody>
                                        @foreach ($bins as $bin)
                                            <tr>
                                                ...
                                                <td>{{ $bin->id_bins }}</td>
                                                <td>{{ $bin->customer->nama }}</td>
                                                <td>{{ $bin->alamat }}</td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/dashboard/bins/{{ $bin->id }}/edit"
                                                            data-toggle="tooltip" class="btn btn-link btn-primary btn-lg"
                                                            data-original-title="Edit Data"><span
                                                                class="fa fa-edit"></span></a>
                                                        <form action="/dashboard/bins/{{ $bin->id }}" method="POST"
                                                            class="d-inline">
                                                            @method('delete')
                                                            @csrf
