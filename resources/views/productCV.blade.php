    ...
    <main>
        ...
        <div class="container" style="margin-top: 2%">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/xience.png" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/trek.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Trek</H3>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/hitorque.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Hi-Torque</H3>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/pleasurewire.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Pleasurewire</H3>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/dragonfly.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Dragonfly Catheter</H3>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/cv/endurity.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Endurity</H3>
