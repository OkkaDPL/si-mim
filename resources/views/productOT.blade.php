    ...
    <main>
        ...
        <div class="container"style="margin-top: 3%">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Orthopaedic</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container" style="margin-top: 2%">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/ot/endobutton.png" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/ot/biosure.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Biosure</H3>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="background-image">
                        <img style="height: 400px;" src="landing/images/product/ot/ultrabutton.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6" style="margin-top: 11%">
                    <H3>Ultrabutton</H3>
