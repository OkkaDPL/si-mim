...
class PurchaseOrderPolicy
{
    ...
    {
        return $user->departement === 'IT' || $user->departement === 'Management' || $user->departement === 'Finance and Accounting';
    }

    public function show(User $user)
    {
        return $user->departement === 'Management' || $user->departement === 'Finance and Accounting';
    }
